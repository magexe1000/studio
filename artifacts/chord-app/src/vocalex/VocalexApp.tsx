...
function TakesPanel() {
  return (
    <div style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24 }}>
      <div style={{ textAlign: 'center' }}>
        <h2 style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 800, fontSize: 22, margin: '0 0 6px', color: 'var(--c-text-primary)' }}>Takes</h2>
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: 'var(--c-text-secondary)', margin: 0, lineHeight: 1.5, maxWidth: 280 }}>Record, compare, and manage your vocal recordings.</p>
      </div>
      <div style={{ width: '100%', maxWidth: 340, height: 120, borderRadius: 16, background: 'var(--c-surface)', border: '1px dashed var(--c-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 8 }}>
        <IconTakes active={false} />
        <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: 'var(--c-text-secondary)' }}>No takes yet</span>
      </div>
    </div>
  );
}
