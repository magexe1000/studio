...
const DEMO_TAKES: Take[] = [
  {
    id: '1',
    name: 'Moonlight_Bridge_Vocal_04',
    date: 'Yesterday, 10:24 PM',
    duration: '0:48',
    starred: false,
    waveform: [30, 60, 80, 50, 90, 70, 40, 65, 85, 45, 55, 75, 35, 50, 70, 60, 40, 80, 55, 45],
  },
  {
    id: '2',
    name: 'Summer_Vibe_Harmony_Take_2',
    date: '2 days ago',
    duration: '1:12',
    starred: false,
    waveform: [40, 55, 70, 45, 60, 50],
  },
  {
    id: '3',
    name: 'Practice_Scales_C_Major',
    date: 'Oct 24, 2023',
    duration: '3:45',
    starred: false,
    waveform: [30, 50, 80, 40],
  },
  {
    id: '4',
    name: 'Chorus_Lead_Draft_Final',
    date: 'Oct 22, 2023',
    duration: '0:32',
    starred: true,
    waveform: [50, 70, 60, 40, 80],
  },
];
...
function TakesPanel() {
  ...
  const activeTake = playingId ? DEMO_TAKES.find(t => t.id === playingId) : null;
  ...
  return (
    <div style={{ padding: '24px 20px', minHeight: '100%' }}>
      ...
      {activeTake && (
        <div style={{
          ...
          <div style={{
            ...
            width: 3, background: '#007aff',
          }} />

          <div style={{
            display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16,
          }}>
            <button onClick={() => togglePlay(activeTake.id)} style={{
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              <h3 style={{
                ...
                fontSize: 16, color: '#e7e5e4', margin: 0,
          ...
          {/* Waveform */}
          <div style={{
            height: 80, background: '#000', borderRadius: 10,
            ...
            {activeTake.waveform.map((h, i) => {
              const isPlayed = (i / activeTake.waveform.length) * 100 < progress;
              return (
                <div key={i} style={{
          ...
          <div style={{
            ...
            fontWeight: 700, color: '#acabaa',
          }}>
            <span>0:{String(Math.floor(progress * 0.48)).padStart(2, '0')}</span>
            <span>-{activeTake.duration}</span>
          </div>
        </div>
      )}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {DEMO_TAKES.filter(t => t.id !== playingId).map(take => (
          <div key={take.id} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0, flex: 1 }}>
              <button onClick={() => togglePlay(take.id)} style={{
                width: 40, height: 40, borderRadius: '50%',
                background: '#191a1a', border: 'none', cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                flexShrink: 0,
              }}>
                <span className="material-symbols-outlined" style={{
                  fontSize: 20, color: '#e7e5e4',
                }}>play_arrow</span>
              </button>
              <div style={{ minWidth: 0 }}>
                <h4 style={{
                  ...
                  {take.starred && (
                    <span className="material-symbols-outlined" style={{
                      fontSize: 14, color: '#007aff', marginLeft: 6,
