...
export const APP_COMMIT_SHA = import.meta.env.VITE_GIT_COMMIT_SHA || '9374d9df';
export const APP_BUILD_TIMESTAMP = import.meta.env.VITE_BUILD_TIMESTAMP || '6/15/2026, 10:58:29 AM CST';
